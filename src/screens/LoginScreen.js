        ...
        return (
            <View style={styles.container}>
                ...
                */
                    ...
                    <KeyboardAvoidingView style={styles.keyboardviewstyle} behavior={"position"}>
                        ...
                        {this.state.verificationId?null:
                            ...
                            >{languageJSON.request_otp}</MaterialButtonWhiteGold>
                        }
                        {!!this.state.verificationId?
                        ...
                        {!!this.state.verificationId?
                            <MaterialButtonWhiteGold
                                ...
                                style={styles.materialButtonGold2}
                                captionstyle={styles.captionstyles}
                            >{languageJSON.authorize}</MaterialButtonWhiteGold>
                        :null}
                        {this.state.verificationId?
