...
import MaterialButtonWhiteGold from "../components/MaterialButtonWhiteGold";
                ...
                > */}
                    ...
                    <KeyboardAvoidingView behavior={"position"}>
                        ...
                        <SegmentedControlTab
                            ...
                            tabTextStyle={{ color: '#212121', fontWeight: 'bold' }}
                            activeTabTextStyle={{ color: '#D9A329' }}
                        />
                        ...
                        :null}
                        <MaterialButtonWhiteGold
                            onPress={this.onAction}
                            style={styles.materialButtonGold}
                            captionstyle={styles.captionstyles}
                        >{this.state.customStyleIndex==0?languageJSON.login_button:languageJSON.register_link}</MaterialButtonWhiteGold>
                        {this.state.customStyleIndex==0?
